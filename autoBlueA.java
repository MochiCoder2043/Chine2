...
public class autoBlueA extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        RFMotor.setTargetPosition(325);
        RBMotor.setTargetPosition(325);
        LFMotor.setTargetPosition(-325);
        LBMotor.setTargetPosition(-325);
        ...
        RBMotor.setTargetPosition(1100);
        LFMotor.setTargetPosition(1100);
        LBMotor.setTargetPosition(1100);
